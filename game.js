/* ============================================================
   ...
   Loaded after data.js (static tables: META, FACTIONS, COM, RECIPES,
   PLANETS, CORE_BASELINE) and galaxygen.js (procedural generation: the
   rotating roster, frontier ring, lane graph, Sector Code, core variance —
   see docs/GALAXYGEN.md), both of which this file assumes are already
   loaded.
   ============================================================ */
