/* ============================================================
   ...
   renderProgression.js, renderCombat.js and renderSettlement.js
   (rendering slices 1-4 — chrome/Galaxy, Market/Industry/Research/
   Politics/Missions, Raid/Contacts/Ship, and Bases/Colonies/Escort;
   only renderAll() the master dispatcher is left below, pending the
   final TABS/PERSISTENCE/INIT slice). This file assumes all of them
   are already loaded.
   ============================================================ */
