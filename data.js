/* ============================================================
   STELLAR FRONTIER — static data tables
   Meta resources, factions, the commodity catalog, production recipes,
   and the 20 charted worlds. Pure data, no game logic — loaded before
   game.js, which depends on everything here.
   ============================================================ */
